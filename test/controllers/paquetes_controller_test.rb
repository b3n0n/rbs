...
class PaquetesControllerTest < ActionController::TestCase
  ...
  test "should create paquete" do
    assert_difference('Paquete.count') do
      post :create, paquete: { descripcion: @paquete.descripcion, nombre: @paquete.nombre, precio: @paquete.precio, tiempo: @paquete.tiempo }
    end
  ...
  test "should update paquete" do
    patch :update, id: @paquete, paquete: { descripcion: @paquete.descripcion, nombre: @paquete.nombre, precio: @paquete.precio, tiempo: @paquete.tiempo }
    assert_redirected_to paquete_path(assigns(:paquete))
  end
